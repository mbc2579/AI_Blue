...
public class ProductController {
    ...
    @ResponseBody
    public ResponseEntity<ProductResDto> deleteProduct(@PathVariable UUID productId, @PathVariable UUID storeId, @RequestHeader(name = "X-User-Name") String userName) {
